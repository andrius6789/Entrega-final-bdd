...
$gameQuery = "SELECT * FROM game_providers?";
$gameResult = $db2->query($gameQuery);
$gameProviders = $gameResult->fetchAll(PDO::FETCH_ASSOC);

?>

<body>
    <div class='main'>
        <h1 class='title'>Proveedores de Juegos</h1>
